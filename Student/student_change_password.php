...
<?php require_once("student_header.php");  ?>
  ...
  <div class="register-box-body">
    ...
    <form action="check_password.php" method="post" onsubmit="return validateForm()" name="myForm">
      
      
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Enter your previous Password" name="password" id="password">
    ...
    echo "<p style='color:red; padding-top=50px ;text-align:center'>Invalid Password!!!</p>";
          }
      }
  ?>
...
-->
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" id="register" class="btn btn-primary btn-block btn-flat" name="add_student" >Verify!</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- /.register-box -->
    ...
    echo "<h3 style='color:green; padding-top=50px ;text-align:center'>You have successfully changed your password!!!</h3>";
          }
      }
  ?>        
